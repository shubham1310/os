...
extern Semaphore* semaphore[];  //Semaphores
extern int semaphoreKeys[];
extern bool UseSemaphore[MAX_SEM_COUNT];
extern Condition* cond[MAX_COND_COUNT]; // Condition Variables
extern int condKeys[MAX_COND_COUNT];   // Hold keys
extern bool UseCond[MAX_COND_COUNT];
...
extern bool UsingPages[NumPhysPages];
