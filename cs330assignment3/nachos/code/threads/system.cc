...
bool UsingPages[NumPhysPages]={0};
...
Semaphore* semaphore[MAX_SEM_COUNT]={0}; // Semaphores
int semaphoreKeys[MAX_SEM_COUNT]={0};   // Hold keys
bool UseSemaphore[MAX_SEM_COUNT]={0};
Condition* cond[MAX_COND_COUNT]={0}; // Condition Variables
int condKeys[MAX_COND_COUNT]={0};   // Hold keys
bool UseCond[MAX_COND_COUNT]={0};
