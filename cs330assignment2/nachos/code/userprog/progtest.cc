...
// StartProcessBatch creates a new thread for the given executable with the given name
// It also initialize the threads various properties like space etc.
...
void StartProcessBatch( char *filename,int p)
{
    ...
    delete executable;         
    SetPriority(p,child->GetPID()); //setting the priority 
